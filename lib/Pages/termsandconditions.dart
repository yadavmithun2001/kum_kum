          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text("Company\'",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16,color: Colors.grey.shade400)),
                Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    Text("Terms and Condition",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 28)),
                  ],
                ),
                SizedBox(height: 20),
                Text(
